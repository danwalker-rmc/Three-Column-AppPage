<template>
    <div :class="$style.ThreeColumnPage">
 ...
 */
export interface IThreeColumnPageProps {
    description: string;
}
 ...
 */
@Component
export default class ThreeColumnPage extends Vue implements IThreeColumnPageProps {
